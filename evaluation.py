...
def decode(examples, model, beam_size, verbose=False, **kwargs):
    if verbose:
...
def evaluate(examples, parser, evaluator, beam_size, verbose=False, return_decode_result=False, eval_top_pred_only=False):
    decode_results = decode(examples, parser, beam_size, verbose=verbose)
